...
export default function InteractiveDiagrams() {
  ...
  const animadoImages = [
    ...
    { id: 2, src: "/assets/oidaterapia/animado-2.png", zIndex: 20, delay: 0.5 }, 
    { id: 3, src: "/assets/oidaterapia/animado-3.png", zIndex: 50, delay: 0.8 }, 
    { id: 4, src: "/assets/oidaterapia/animado-4.png", zIndex: 60, delay: 1.1 }, 
    { id: 5, src: "/assets/oidaterapia/animado-5.png", zIndex: 30, delay: 1.4 }, 
    { id: 6, src: "/assets/oidaterapia/animado-6.png", zIndex: 40, delay: 1.7 }, 
  ];
