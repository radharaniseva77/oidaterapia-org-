  ...
  return (
    <div className="fixed bottom-6 right-6 z-[100] flex items-center justify-center">
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="w-16 h-16 bg-[#25D366] hover:bg-[#1DA851] flex items-center justify-center rounded-full shadow-2xl transition-all cursor-pointer border-2 border-white/20"
      >
        <svg className="w-8 h-8 text-white ml-[1px] mb-[1px]" fill="currentColor" viewBox="0 0 24 24">
